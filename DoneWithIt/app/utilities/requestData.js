...
export async function userExists(email) {
  //endpoint url
  const url =
    "https://data.mongodb-api.com/app/data-ndazo/endpoint/data/v1/action/findOne";
...
export async function insertNewUser(
  ...
  const options = {
    ...
    body:
      '{"dataSource": "DripCheckApp", "database": "test", "collection": "users",' +
      ' "document": {' +
      '"email" : "' +
      email +
      '",' +
...
export async function deleteUser(email) {
  //endpoint url
  const url =
    "https://data.mongodb-api.com/app/data-ndazo/endpoint/data/v1/action/deleteOne";
...
export async function getAllOutfits(email) {
  ...
  const options = {
    ...
    body:
      '{"dataSource": "DripCheckApp", "database": "test", "collection": "outfits", "document": { "email": "' +
      email +
      '" }}',
  };
 ...
 */
export async function addNewOutfit(
  email,
  outfitName,
  description,
  imageString,
...
export async function removeAllOutfits(email) {
  ...
  //TODO: Make db function to gather all outfits belonging to a specific user
  const url =
    "https://data.mongodb-api.com/app/data-ndazo/endpoint/data/v1/action/deleteMany";
...
export async function getDaysUser(email) {
  ...
  //endpoint url
  const url =
    "https://data.mongodb-api.com/app/data-ndazo/endpoint/data/v1/action/find";
